...
import { Linkedin, Github, Mail, MapPinned, HomeIcon, Layers } from "lucide-react"; // Import icons
    ...
    <div className="fixed top-0 left-0 h-full w-64 bg-gray-900 border-r-8 border-white z-45">
      ...
      <nav>
        ...
        <a
          key={label}
          href={href}
          className={`px-4 py-2 text-white rounded flex items-center gap-2 hover:font-semibold ${color}`}
        >
          {icon}
          {label}
        </a>
