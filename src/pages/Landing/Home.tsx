...
export default function BrutalistAlgorithmVisualizer() {
  ...
  return (
    <div className="bg-primary min-h-screen text-white font-mono">
      {/* Main Hero */}
      <div className="bg-secondary border-b-8 border-white">
        <div className="mx-auto max-w-6xl p-6 py-24">
          ...
          {/* <div className="flex gap-4">
            <button className="bg-white text-gray-900 text-xl px-8 py-4 font-bold flex items-center gap-2 hover:bg-textDim">
      ...
      <div className="bg-white text-gray-900 mt-16">
        <div className="mx-auto max-w-6xl p-32 py-32">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <button onClick={() => window.location.href = "/pathfinding-visualizer"} className="bg-gray-900 text-white text-xl px-8 py-4 font-bold hover:bg-gray-700">
              CHECK IT OUT
            </button>
          </div>
        </div>
